        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <motion.div variants={itemVariants} className="lg:col-span-1">
            ...
            <div className="flex space-x-3">
              ...
              />
              <SocialIcon
                href="https://discord.gg/quantsedge"
                name="Discord"
                icon={
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-4">
              <FooterLink href="/research" external>Research Papers</FooterLink>
              <FooterLink href="/blog" external>Blog</FooterLink>
              <FooterLink href="/guides" external>Trading Guides</FooterLink>
              <FooterLink href="/webinars" external>Webinars</FooterLink>
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-4">
              ...
              <FooterLink href="/investors" external>Investors</FooterLink>
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-6 md:space-y-0">
            ...
            <div className="flex flex-wrap items-center gap-6 text-sm">
              ...
              <FooterLink href="/aml" external>AML Policy</FooterLink>
              <FooterLink href="/cookies" external>Cookie Policy</FooterLink>
            </div>

            {/* Contact Info */}
            <div className="text-sm text-text-secondary">
              <p className="mb-1">Questions? <span className="text-accent">hello@quantsedge.ai</span></p>
              <p className="font-mono text-xs">Enterprise: <span className="text-accent">enterprise@quantsedge.ai</span></p>
            </div>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-white/5">
            <div className="flex flex-col md:flex-row justify-between items-start space-y-4 md:space-y-0">
              <div className="text-sm text-text-tertiary">
                <p>© {currentYear} QuantsEdge Technologies, Inc. All rights reserved.</p>
                <p className="mt-1 text-xs">
                  QuantsEdge® is a registered trademark. Licensed and regulated by relevant financial authorities.
                </p>
              </div>
